...
\begin{definition}[sunset-by-default]
A law lapses unless it is re-enacted. With lifetime $\tau\ge1$, a placed law
survives a step if some active law enacts it now, or if fewer than $\tau$ steps
have passed since its last enactment. Effects are \emph{enactments}, not
toggles; to repeal is to stop re-enacting.
\end{definition}
\begin{figure}[t]
\centering
