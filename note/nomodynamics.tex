...
experiment---identical guards, offsets and cell-clearing, varying only the
creation out-degree---giving $0$ gliders in $1{,}119{,}744$ complete
classifications at out-degree~$1$ and $1{,}744$ at out-degree~$2$. So
...
(1)~\emph{Speed quantisation.} At $W=1$ the numerator of the reduced speed is
capped at $1$ for two kinds and at $2$ for three (speeds $2/3$, $2/5$, $2/7$
exist; anything with numerator $\ge3$ is decided impossible up to $p\le8$), and
the cap disappears at four kinds. Neither the trivial bound $|d|/p\le W$ nor
the Tropical Speed Law mentions the number of kinds: what invariant does?
