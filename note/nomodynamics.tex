...
colonizer assimilates a self-eroding \emph{sunset wall} at half speed
(refraction index $\approx2$), with a transient scar at contact.}
\label{fig:spacetime}
\end{figure}
\begin{figure}[t]
\centering
...
300{,}000 fully-hashed steps, quiescent except at $t=2^k$ when the whole code
ignites and collapses---a binary counter native to law-space, and an
