...
(1)~\emph{Displacement quantisation.} At $W=1$ two kinds realize only $|d|=1$,
three kinds exactly $|d|\le2$ (speeds $2/3$, $2/5$, $2/7$ exist; everything
faster is decided impossible up to $p\le8$), and four kinds realize every
coprime $(p,d)$ tested. Neither the trivial bound $|d|/p\le W$ nor the Tropical
Speed Law mentions the number of kinds: what invariant does?
